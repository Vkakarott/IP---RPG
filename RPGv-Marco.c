...
int main() {
    ...
    scanf("%i", &class);
        ...
        switch (class) {
            ...
            case 2: //Classe do Paladino, +HP -MP
                playerHPmax = 30 * 4/3; //Fiz dessa forma para aumentar o HP ou diminuir, mas se acharem uma forma melhor, fiquem a vontade. 
                playerHPcurr = playerHPmax;
                playerMPmax = 20 * 0.75;
                playerMPcurr = playerMPmax;
                playerAtk = 12;
    ...
    do {
        ...
        if (acao == 1) {
            danoPlayer = playerAtk*(1+0.1*strength);
            enemyHP -= danoPlayer;
            ...
            case 1: //ataque especial
                ...
                danoPlayer = 2*playerAtk*(1+0.1*strength);
                enemyHP -= danoPlayer;
            ...
            case 3: //buffar
                ...
                strength += playerMPmax*1/5;
                printf("VOCÊ RECEBEU +%.1lf Atk E GASTOU %.1lf MANA\n", playerMPmax*1/5, playerMPmax/2);
                Sleep(1000);
                break;
                } else {
                    printf("Sem mana suficiente\n");
        ...
        danoInimigo = (6-defesa)/(1+1*0.1*res);
